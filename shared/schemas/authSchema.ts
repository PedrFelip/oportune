import * as regex from "../validators/regex";
import { z } from "zod";
...
const estudanteSchema = z.object({
  ...
  dataNascimento: z.preprocess(
    (arg: string | number | Date) =>
      typeof arg === "string" ? new Date(arg) : arg,
    z.date()
  ),
...
const createUserSchema = z.discriminatedUnion("tipo", [
...
export const createUserCleanSchema = createUserSchema.transform((data: any) => {
