                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <p className="text-gray-300 text-lg mb-8 leading-relaxed">
                            Estágios, projetos de pesquisa e extensão em um só
                            lugar — perfis personalizados, busca inteligente e
                        ...
                        <div className="space-y-4">
                            <div className="bg-slate-700/50 p-4 rounded-lg hover:bg-slate-700/70 transition-colors cursor-pointer">
                                ...
                                <p className="text-sm text-gray-400 mb-2">
                                    Empresa X • Curso: Engenharia de Software •
                                    Até 30/09
                                </p>
                            </div>
                            <div className="bg-slate-700/50 p-4 rounded-lg hover:bg-slate-700/70 transition-colors cursor-pointer">
            ...
            <section className="mid-content px-6 py-26  ">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    ...
                    <Card className="oportune-card p-6">
                        ...
                        <p className="text-gray-300">
                            Alcance talentos qualificados com filtros por curso
                            e semestre.
                        </p>
                    </Card>
                    ...
                    <Card className="oportune-card p-6">
                        ...
                        <p className="text-gray-300">
                            Divulgue projetos de pesquisa e extensão e gerencie
                            inscrições com facilidade.
                        </p>
                    </Card>
                </div>
            </section>
            ...
            <section className="px-6 py-16 max-w-7xl mx-auto">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    <Card className="testimonial-card p-6 cursor-pointer">
                        ...
                        <p className="text-gray-300 text-sm">
                            "Encontrei meu primeiro estágio em menos de um mês.
                            Plataforma incrível"
                        </p>
                    </Card>
                    ...
                    <Card className="testimonial-card p-6 cursor-pointer">
                        ...
                        <p className="text-gray-300 text-sm">
                            Foi aqui que eu consegui encontrar minha residência,
                            estou muito feliz com a plataforma
                        </p>
                    </Card>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-8 mt-8">
                    ...
                    <Card className="testimonial-card p-6 cursor-pointer">
                        ...
                        <p className="text-gray-300 text-sm">
                            "Encontrei meu primeiro emprego na área através
                            dessa plataforma muito boa recomendo"
                        </p>
                    </Card>
