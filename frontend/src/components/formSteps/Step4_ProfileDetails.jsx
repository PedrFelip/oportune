  ...
  const forms = {
    ESTUDANTE: (
      <>
        ...
        />
        <FormInput id="curso" name="curso" label="Curso" placeholder="Digite seu curso" value={formData.curso || ''} onChange={handleChange} />
        <FormInput id="semestre" name="semestre" label="Semestre Atual" type="number" placeholder="Qual semestre você está atualmente?" value={formData.semestre || ''} onChange={handleChange} />
        <FormInput id="matricula" name="matricula" label="Número de Matrícula" placeholder="Qual a sua matricula" value={formData.matricula || ''} onChange={handleChange} />
        <FormSelect id="periodo" name="periodo" label="Periodo" options={informacoes.periodo} value={formData.periodo || null} onChange={(option) => handleSelectChange("periodo", option)} />
      </>
    ),
    EMPRESA: (
      <>
